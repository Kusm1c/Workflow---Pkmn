...
public static class Doors
{
    ...
    {
        { new Vector3(-31.9199982f,-5.6800251f,0f), 10 },
        { new Vector3(-31.2799988f,-2.96002603f,0f), 4 },
        { new Vector3(-30f,-3.92002654f,0f), 6 },
        { new Vector3(-28.8800011f,-2.96002603f,0f), 2 },
        { new Vector3(-27.2800026f,-4.56002617f,0f), 11 },
